package fr.sinouplen.supremacy.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof fr.sinouplen.supremacy.service.EmailAlreadyUsedException ||
            ex instanceof fr.sinouplen.supremacy.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof fr.sinouplen.supremacy.service.InvalidPasswordException
